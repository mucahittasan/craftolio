    ...
    <div className="w-full max-w-md rounded-2xl border border-black/10 bg-white/10 p-8 shadow-2xl backdrop-blur-lg dark:border-white/10 dark:bg-black/10">
      <div className="text-center">
        ...
        <p className="mt-2 text-muted-foreground">
          Start your journey with Craftolio today.
        </p>
      </div>
      ...
      <form action={dispatch} className="mt-8 space-y-6">
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-white/10 px-2 text-muted-foreground backdrop-blur-sm dark:bg-black/10">
              Or continue with
            </span>
          </div>
        </div>
        ...
        <Button
          type="button"
          variant="outline"
          className="w-full gap-2 border-black/10 bg-white hover:bg-gray-50 dark:border-white/10 dark:bg-white dark:text-black dark:hover:bg-gray-100"
