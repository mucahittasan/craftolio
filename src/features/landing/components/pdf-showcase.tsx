    ...
    <section id="pdf-showcase" className="relative py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          {/* Left: Visual mockup with real content */}
          <div className="relative">
            ...
            <div className="relative">
              ...
              <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-xl dark:border-gray-800 dark:bg-gray-900">
                ...
                {/* PDF Content Preview with Real Data */}
              ...
              {/* Floating badge */}
              <div className="absolute -bottom-4 -right-4 rounded-xl border border-gray-200 bg-white p-3 shadow-lg dark:border-gray-700 dark:bg-gray-800">
                <div className="flex items-center gap-2">
